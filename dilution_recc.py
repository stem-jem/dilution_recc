...
"""
def dilution_rec(chop_ppm,p_conc,chop_ng='',sample_id=1,target=[1,3,12,40,100],target_v=50,vol_min=5,vol_max=200,drop_null=True):
    """
    ...
    -----
    chop_ppm: float
        Ppm lelve of CHOP in starting sample. CHOP ppm is measure on a part CHOP
        to part protein of interest.
    p_conc: float
        Concentration of protein of interest. Typically mAb product.
